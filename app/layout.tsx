    ...
    <html lang="en" className={`${display.variable} ${body.variable} ${mono.variable}`}>
      <body className="min-h-screen font-body">
        ...
        <footer className="border-t border-ink-line/70 py-8 text-center font-body text-xs text-text-faint">
          Fan-made guide for Roll Anime to Fight. Not affiliated with the game&apos;s
          developers or Roblox Corporation. Data is community-sourced and may drift
          from the live game — verify big decisions in-game.
        </footer>
        <DiscordButton />
      </body>
    </html>
