...
export default function DiscordButton() {
  return (
    <a
      ...
      className="group fixed bottom-5 right-5 z-50 flex items-center gap-3 rounded-full border border-white/10 bg-[#5865F2] pl-4 pr-5 py-3 text-white shadow-glow transition-transform hover:scale-105 active:scale-95 sm:bottom-6 sm:right-6"
    >
